   ...
   override func didReceiveMemoryWarning() {
    ...
    func searchBar(searchBar: UISearchBar, textDidChange searchText: String) {
        if searchText == ""{
            ...
            manager.POST("http://192.168.0.5/eshopkart/webservices/search", parameters: params, success: { (operation : AFHTTPRequestOperation!, response : AnyObject!) -> Void in
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        print("\(params)")
        manager.POST("http://192.168.0.5/eshopkart/webservices/get_product_details", parameters: params, success: { (operation : AFHTTPRequestOperation!, response : AnyObject!) -> Void in
            print("response: \(response!)")
